...
//-----------------------------------------------------------------------------
class CD3DApplication : public SoundInterface, public CursorInterface
{
protected:
...
protected:
	...
	POINT			  m_cursorPosition;	   // The position of the cursor
...
public:
	...
	virtual void *GetImplementation() { return NULL; }
	// From the cursor interface
	virtual void ShowCursor(bool bShow, CursorInterface::CursorType type) {bShow;type;}
